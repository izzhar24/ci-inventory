...
class M_barang extends CI_Model
{
	...
	function update_barang($kobar, $nabar, $kat, $satuan, $harpok, $harjul, $harjul_grosir, $stok, $min_stok, $user_id)
	{
	...
	{
		$hsl = $this->db->query("UPDATE tbl_barang SET `status`=$mode WHERE barang_id='$kode'");
		return $hsl;
	}
}
