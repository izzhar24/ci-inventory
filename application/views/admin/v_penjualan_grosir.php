<div class="card">
    <div class="card-header">
        <div class="card-title">Transaksi Penjualan (Grosir)</div>
    </div>
    <div class="card-body">
            ...
            <tbody>
                ...
                <?php foreach ($this->cart->contents() as $items) : ?>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;"><a href="<?php echo base_url() . 'penjualan_grosir/remove/' . $items['rowid']; ?>" class="btn btn-warning btn-xs btn-square"><span class="fa fa-close"></span></a></td>
                    </tr>
        ...
        <form action="<?php echo base_url() . 'penjualan_grosir/simpan_penjualan_grosir' ?>" method="post">
            <table>
                <tr>
                    <td style="width:760px;" rowspan="2"><button type="submit" class="btn btn-primary btn-square "> Simpan</button></td>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-square btn-info" data-dismiss="modal" aria-hidden="true">Tutup</button>
