...
class Auth extends CI_Controller
{
	...
	public function login()
	{
		...
		if ($this->form_validation->run() === TRUE) {
			...
			if ($this->ion_auth->login($this->input->post('identity'), $this->input->post('password'), $remember)) {
				...
				// $group_id = $this->m_main->get_users_groups();
				$id = $this->session->userdata('user_id');
				$group_id = $this->ion_auth->get_users_groups($id)->row();
	...
	public function deactivate($id = NULL)
	{
		...
		if ($this->form_validation->run() === FALSE) {
			...
			$this->template->load('template', 'auth' . DIRECTORY_SEPARATOR . 'deactivate_user', $this->data);
		} else {
	...
	public function register()
	{
		...
		if ($this->ion_auth->logged_in()) {
			...
			if ($this->form_validation->run() === TRUE && $this->ion_auth->register($identity, $password, $email, $additional_data)) {
				...
				$this->session->set_flashdata('message', 'Registrasi user berhasil, silahkan login');
	...
	public function create_user()
	{
		...
		if (!$this->ion_auth->logged_in()) {
			...
			if ($this->form_validation->run() === TRUE && $this->ion_auth->register($identity, $password, $email, $additional_data)) {
				...
				$this->template->load('template', 'auth' . DIRECTORY_SEPARATOR . 'create_user', $this->data);
			}
		}
	}
	/**
	...
	public function edit_group($id)
	{
		...
		$this->template->load('template', 'auth' . DIRECTORY_SEPARATOR . 'edit_group', $this->data);
	}
